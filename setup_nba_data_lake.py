...
bucket_name = "mykunle34buck1e4t"  # Change to a unique S3 bucket name
glue_database_name = "glue_nba_data_lakjamiu413e"
athena_output_location = f"s3://{bucket_name}/athena-results/"

# Sportsdata.io configurations (loaded from .env)
api_key = "41e75d47cbda4b28887896ffc7a1b2bd"  # Get API key from .env
nba_endpoint = "https://api.sportsdata.io/v4/nba/stats/json/PlayerSeasonStats/2023"  # Get NBA endpoint from .env
